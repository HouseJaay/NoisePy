...
rootpath  = '/home/shijie001/data/hawaii'                        # root path for this data processing
...
locations = os.path.join(rootpath,'DOWNLOAD/station.txt')           # station info including network,station,channel,latitude,longitude,elevation
